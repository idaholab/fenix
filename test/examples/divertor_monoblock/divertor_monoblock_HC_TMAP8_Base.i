...
# Mesh
rings = '1 6 4 20'# '1 10 8 30' # '1 30 20 110' # Number of rings in each circle or in the enclosing square of the mesh
num_layer_mesh_thickness = 5 # 8
...
[Problem]
    ...
    # converge_on = 'temperature C_mobile_W C_trapped_W C_mobile_Cu C_trapped_Cu C_mobile_CuCrZr C_trapped_CuCrZr'
[]
