#include "DensityAccumulator.h"
#include "ResidualAccumulator.h"
#include "PICStudyBase.h"
#include "MooseMesh.h"

registerMooseObject("FenixApp", DensityAccumulator);

InputParameters
DensityAccumulator::validParams()
{
  ...
  // This exec flag is necessary for the DensityAccumulator to contribute to residuals
...
DensityAccumulator::DensityAccumulator(const InputParameters & params)
