...
#include "InitializedPICStudy.h"

#include "ClaimRays.h"
#include "InitializerBase.h"
#include "ParticleStepperBase.h"

registerMooseObject("FenixApp", InitializedPICStudy);

InputParameters
InitializedPICStudy::validParams()
{
...
InitializedPICStudy::InitializedPICStudy(const InputParameters & parameters)
...
RayID
InitializedPICStudy::generateUniqueRayID(const THREAD_ID /*tid*/)
{
